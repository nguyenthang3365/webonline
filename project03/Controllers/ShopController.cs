...
namespace project03.Controllers
{
    public class ShopController : Controller
    {
        ...
        public ActionResult render_product()
        {
            ...
            var hanghoa = model.HangHoas.Where(s=>s.Gia>=1000).ToList();
        ...
        public ActionResult render(int Id)
        {
            ...
            var hanghoa= model1.HangHoas.Where(h => h.MaLoai == Id).ToList();
            return PartialView("New_product", hanghoa);
        }
        ...
        {
            var detail_product = model.HangHoas.FirstOrDefault(s => s.MaHang == id);
